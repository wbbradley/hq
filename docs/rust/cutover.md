...
passed for exact candidate revision `f408702866faeeb2530ecedff4a25f9786bea8be`. The synthetic
archived-Go rollback job passed in 15 seconds, including clean Rust shutdown, unchanged archive
metadata, no archived binary start, no archived-state open, offline selector replacement, and
preservation of unrelated target-directory HQ processes.

The combined candidate artifact was downloaded independently. All five evidence validators passed;
the release, recovery, and cutover aggregates regenerated byte-for-byte. Evidence SHA-256 values:
...
| Cutover rollback | `3ce865460c8dc8f8c974cadf2e5595c1e31c0444bce0ced8ec74a4031b1b3c38` |
| Cutover bundle | `b61b0997c87c46fd9a9c155f26e690e2c0925fd41bb1db3d5bc27338358a6fdf` |

The bundle records `soak_authorization: operator_required`, `cutover_authorization:
separate_operator_required`, and `activation: not_performed`. No tag, publication, live service
change, production identity access, soak, or cutover occurred.
