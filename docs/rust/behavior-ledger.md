...
| MSG-007 | redesign | required | Ordered technical disclosure | Bounded namespaced technical sections are display diagnostics and never authority or routing input. | `docs/rust/tui.md`; typed TUI routing/semantics/evidence/activity mapping and render tests |
