...
| ID | Classification | Release | Capability or behavior | Rust contract | Evidence and downstream owner |
| --- | --- | --- | --- | --- | --- |
| CLI-001 | redesign | required | Reconnecting local API | Strict framed v1 negotiation, build metadata, typed requests/results/errors, reconnect, and full-snapshot recovery. | `docs/rust/cli.md`; `hq-local-api` reconnecting-client and blocking-runner tests; `hq-node/tests/unix_node_cli.rs` |
...
| CLI-005 | redesign | required | Lifecycle status, stop, and restart | Typed lifecycle control drains ownership; clients reconnect/resubscribe and detect build/version incompatibility. | `docs/rust/cli.md`; node/local API runner and Unix lifecycle tests |
