...
| MSG-007 | redesign | required | Ordered technical disclosure | Bounded namespaced technical sections and exact activity detail are display diagnostics and never authority, routing, or ordinary-summary input. | `docs/rust/tui.md`; typed TUI routing/semantics/evidence/activity mapping and render tests |
