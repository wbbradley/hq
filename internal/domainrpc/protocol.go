...
const (
	...
	PreviewHarnessProjectCloseMethod = "harness/project/close/preview"
	ReplaceHarnessProjectMethod      = "harness/project/replace"
...
const (
	...
	CodeProjectCloseForceRequired = "project_close_force_required"
...
func EncodeError(err error) *localwire.RPCError {
	...
	case errors.Is(err, domain.ErrProjectCloseForceRequired):
		code = CodeProjectCloseForceRequired
...
func DecodeError(err error) error {
	...
	case CodeProjectCloseForceRequired:
		sentinel = domain.ErrProjectCloseForceRequired
