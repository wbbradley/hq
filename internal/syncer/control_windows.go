...
func startControl(context.Context, RuntimePaths, chan<- struct{}, context.CancelFunc, context.CancelFunc, func() string, localwire.PeerMetadata, *localwire.ModeConfig) (io.Closer, error) {
